...
function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    // HIDDEN: { path: '/era-tracking', label: 'ERA Tracking', perm: 'era_tracking', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    ...(isAdmin ? [
      ...
      // HIDDEN: { path: '/system-health', label: 'System Health', perm: 'system_health', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
    ] : []),
  ];
      ...
      <AuthProvider>
        <Routes>
          ...
          */}
          ...
          {/* HIDDEN: <Route path="/era-tracking" element={<LayoutRoute><ERATracking /></LayoutRoute>} /> */}
          ...
          {/* HIDDEN: <Route path="/system-health" element={<LayoutRoute><SystemHealth /></LayoutRoute>} /> */}
